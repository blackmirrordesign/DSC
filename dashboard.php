...
<!-- Page Content -->
<!-- <div class="row "> -->
<div id="wrapper" class="dashboard col-lg-12 col-md-12 col-sm-12  d-flex justify-content-center ">
    <div class="col-lg-12 col-md-12 col-sm-12 align-content-center ">
        ...
        <div class="row" id="tabs">
            <div class="col-lg-12 col-md-12 col-sm-12 ui-tabs"  >
                <ul class="ui-tabs-nav top-tabs-dash col-12">
                    ...
                    <li class="ui-tabs-collapsible text-center"><a href="#tabs-4">admin</a></li>
                ...
                <div id="tabs-2" class="ui-tabs-panel">
                    <div id="accordion">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 accordion-content ">
                            <form class="row">
                                <div class="col-lg-8 col-md-8 col-sm-12 float-left p-0 m-0">
                                    <div class="form-group row mt-1 mb-0">
                                        <label for="exampleInputName" class="col-2 col-form-label">Name</label>
                                        <div class=" col-lg-10 col-md-10 col-sm-12 float-right ">
                                    ...
                                    <div class="form-group row mt-1 mb-0">
                                        ...
                                        <input type="telephone" class="form-control col-md-5 col-sm-10 ml-3" id="Phone" aria-describedby="Phone">
                                        <label for="exampleTextarea " class="col-lg-2 col-md-2 col-sm-2 ml-2">EXT</label>
                                        <input type="telephone" class="form-control col-md-2 col-sm-8  " id="phoneEXT" aria-describedby="EXT">
                                    </div>
                                    <div class="form-group row mt-1 mb-0">
                            ...
                            <div class="row">
                                <div class=" col-lg-7 col-md-8 col-sm-12 float-left">
                                    <div class="form-group row ">
                                        <label for="exampleFormControlSelect1" class=" col-lg-2 col-md-2 col-sm-2 col-form-label">Monday</label>
                                        <div class="col-lg-4 col-md-4 col-sm-2 float-right ml-4">
                                        ...
                                        <label for="exampleFormControlSelect1" class=" col-lg-1 col-md-1 col-sm-1 col-form-label">to</label>
                                        <div class="col-lg-4 col-md-4 col-sm-2 float-right">
                                            <select class="form-control" id="exampleFormControlSelect1">
                                                <option>12</option>
                                                <option>1</option>
                                                <option>2</option>
                                    ...
                                    <div class="form-group row ">
                                        <label for="exampleFormControlSelect1" class="col-lg-2 col-md-2 col-sm-2  col-form-label">Tuesday</label>
                                        <div class="col-lg-4 col-md-4 col-sm-2 float-right ml-4">
                                            <select class="form-control " id="exampleFormControlSelect1">
                                                <option>12</option>
                                                <option>1</option>
                                    ...
                                    <div class="form-group row ">
                                        <label for="exampleFormControlSelect1" class="col-lg-2 col-md-2 col-sm-2 col-form-label">Wednesday</label>
                                        <div class="col-lg-4 col-md-4 col-sm-2 float-right  ml-4">
                                    ...
                                    <div class="form-group row ">
                                        <label for="exampleFormControlSelect1" class="col-lg-2 col-md-2 col-sm-2 col-form-label">Thursday</label>
                                        <div class="col-lg-4 col-md-4 col-sm-2 float-right  ml-4">
                                            <select class="form-control m-auto" id="exampleFormControlSelect1">
                                                <option>12</option>
                                                <option>1</option>
                                    ...
                                    <div class="form-group row ">
                                        <label for="exampleFormControlSelect1" class="col-lg-2 col-md-2 col-sm-2 col-form-label">Friday</label>
                                        <div class="col-lg-4 col-md-4 col-sm-2 float-right  ml-4">
                                            <select class="form-control m-auto" id="exampleFormControlSelect1">
                                                <option>12</option>
                                                <option>1</option>
                                    ...
                                    <div class="form-group row ">
                                        <label for="exampleFormControlSelect1" class="col-lg-2 col-md-2 col-sm-2 col-form-label">Saturday</label>
                                        <div class="col-lg-4 col-md-4 col-sm-2 float-right ml-4">
                                            <select class="form-control m-auto" id="exampleFormControlSelect1">
                                                <option>12</option>
                                                <option>1</option>
                                    ...
                                    <div class="form-group row ">
                                        <label for="exampleFormControlSelect1" class="col-lg-2 col-md-2 col-sm-2  col-form-label">Sunday</label>
                                        <div class="col-lg-4 col-md-4 col-sm-2 float-right ml-4">
                                            <select class="form-control m-auto" id="exampleFormControlSelect1">
                                                <option>12</option>
                                                <option>1</option>
                                ...
                                <div class="col-lg-5 col-md-4 col-sm-8 text-right float-right">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 accordion-content ">
                            ...
                            <table class="col-md-12 col-sm-12">
                                <tbody >
                                    <tr class="card col-md-12 col-sm-12 m-2">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 accordion-content ">
                            <div class="form-group row">
                            <div class=" col-md-5 col-sm-12 ">
                                <label for="exampleFormControlSelect2">Primary Focus:</label>
                                <select multiple class="form-control" id="exampleFormControlSelect2">
                                <option>Anxiety/Panic Disorders Counseling</option>
                                <option>Addiction / Drug /Alcohol Counseling</option>
                                <option>Communication / Social Skills Counseling</option>
                                <option>Christian / Pastoral Counseling</option>
                                <option>Grief Counseling</option>
                                </select>
                            </div>
                            <div class="col-md-7  col-sm-12">
                                <label for="exampleFormControlSelect1" class="col-form-label">Range of Focus:</label>
                                         <div class="dropdown-container">
                                            <div class="dropdown-button noselect">
                        ...
                        <h3 >PRACTICE</h3>
                        <div class="col-lg-12 col-md-12 col-sm-12 accordion-content" id="practice">
                            <div class="input-group mt-3">
                                <div class="input-group-prepend col-md-2 col-sm-3 p-0 ">
                ...
                <div id="tabs-4" class="ui-tabs-panel">
                        <div id="accordion-admin">
                            <h3 class="mb-2">GENERAL</h3>
                            <div class="col-md-10 col-sm-12 offset-md-1 accordion-content ">
                                <form clsss="row">
                            ...
                            <h3 class="mb-2">FOCUS</h3>
                            <div class="col-md-10 offset-md-1 col-sm-12 accordion-content ">
                                <div class="form-group row">
                                <div class=" col-md-5 col-sm-12 ">
                                ...
                                <div class="col-md-7  col-sm-12">
                                    <label for="exampleFormControlSelect1" class="col-form-label">Issues:</label>
                                            <div class="dropdown-container">
                                                <div class="dropdown-button noselect">
                                                    <div class="dropdown-label">States</div>
                                                    <div class="dropdown-quantity">(<span class="quantity">Any</span>)</div>
                            ...
                            <h3 >PRACTICE</h3>
                            <div class="col-md-10 col-sm-12 offset-md-1 accordion-content" id="practice">
                                <div class="input-group mt-3">
