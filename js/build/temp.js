...
var usStates = [{ name: 'Addictive / Compulsive Behaviors', abbreviation: 'ADI' }, { name: 'Addressing Mental Health & Wellness in Recovery', abbreviation: 'ADR' }, { name: 'Agoraphobia', abbreviation: 'AG' }, { name: 'All anxiety disorders', abbreviation: 'ALL' }, { name: 'Anxiety', abbreviation: 'ANX' }, { name: 'Abuse', abbreviation: 'AB' }, { name: 'Relapse Prevention', abbreviation: 'REl' }, { name: 'Early Adulthood Concerns', abbreviation: 'EDC' }, { name: 'Gifted and Talented', abbreviation: 'GT' }, { name: 'Life Adjustment', abbreviation: 'LA' }, { name: 'Hoarding', abbreviation: 'HO' }, { name: 'Shyness', abbreviation: 'SH' }, { name: 'Trust Issues', abbreviation: 'TI' }];

// <li> template
var stateTemplate = _.template('<li class="multiselect">' + '<input name="<%= abbreviation %>" type="checkbox">' + '<label for="<%= abbreviation %>"><%= capName %></label>' + '</li>');
